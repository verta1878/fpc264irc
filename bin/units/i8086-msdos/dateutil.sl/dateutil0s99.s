...
SECTION text
	ALIGN 2
	GLOBAL DATEUTILS_$$_SECONDSBETWEEN$TDATETIME$TDATETIME$$INT64
DATEUTILS_$$_SECONDSBETWEEN$TDATETIME$TDATETIME$$INT64:
		push	bp
		mov	bp,sp
		sub	sp,20
		fstcw	[bp-12]
		...
		wait faddp	st1,st0
		wait fld	tword [_$DATEUTILS$_Ld8]
		wait fmulp	st1,st0
		wait fldcw	[bp-12]
