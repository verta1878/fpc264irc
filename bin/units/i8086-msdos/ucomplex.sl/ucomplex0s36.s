...
SECTION text
	ALIGN 2
	GLOBAL UCOMPLEX_$$_CARC_SIN$COMPLEX$$COMPLEX
UCOMPLEX_$$_CARC_SIN$COMPLEX$$COMPLEX:
		push	bp
		mov	bp,sp
		sub	sp,80
		mov	ax,word [bp+4]
		...
		lea	ax,[bp-64]
		push	ax
		call	UCOMPLEX_$$_CARG_SH$COMPLEX$$COMPLEX
		lea	di,[bp-32]
		push	ss
		pop	es
		lea	si,[bp-48]
		...
		pop	bp
		ret	4
EXTERN	UCOMPLEX_$$_CARG_SH$COMPLEX$$COMPLEX
