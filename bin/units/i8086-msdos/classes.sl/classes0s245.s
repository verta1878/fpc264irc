...
SECTION .text
	ALIGN 2
	GLOBAL CLASSES$_$TFPLIST_$_DODESTUNIQUE$TFPLIST$TFPLIST_$$_MOVEELEMENTS$TFPLIST$TFPLIST
CLASSES$_$TFPLIST_$_DODESTUNIQUE$TFPLIST$TFPLIST_$$_MOVEELEMENTS$TFPLIST$TFPLIST:
		push	bp
		mov	bp,sp
		sub	sp,4
		mov	bx,word [bp+8]
