...
SECTION .text
	ALIGN 2
	GLOBAL CLASSES$_$TCOMPONENT_$__$$_INSERTCOMPONENT$TCOMPONENT
CLASSES$_$TCOMPONENT_$__$$_INSERTCOMPONENT$TCOMPONENT:
		push	bp
		mov	bp,sp
		push	word [bp+4]
		push	word [bp+6]
		...
		push	word [bp+6]
		push	word [bp+4]
		call	CLASSES$_$TCOMPONENT_$__$$_INSERT$TCOMPONENT
		push	word [bp+4]
		mov	ax,1
		push	ax
...
EXTERN	CLASSES$_$TCOMPONENT_$__$$_INSERT$TCOMPONENT
