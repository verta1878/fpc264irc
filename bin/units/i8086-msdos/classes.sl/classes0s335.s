...
SECTION .text
	ALIGN 2
	GLOBAL CLASSES$_$TSTRINGS_$__$$_ERROR$PANSISTRING$SMALLINT
CLASSES$_$TSTRINGS_$__$$_ERROR$PANSISTRING$SMALLINT:
		push	bp
		mov	bp,sp
		sub	sp,6
		mov	ax,word VMT_$CLASSES_$$_ESTRINGLISTERROR
		push	ax
		mov	ax,1
		push	ax
		mov	bx,word [bp+6]
...
EXTERN	VMT_$CLASSES_$$_ESTRINGLISTERROR
