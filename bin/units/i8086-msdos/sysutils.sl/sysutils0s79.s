...
SECTION text
	ALIGN 2
	GLOBAL SYSUTILS_$$_FILESETDATE$UNICODESTRING$LONGINT$$LONGINT
SYSUTILS_$$_FILESETDATE$UNICODESTRING$LONGINT$$LONGINT:
		push	bp
		mov	bp,sp
		sub	sp,20
		push	word [bp+8]
		mov	ax,1
		push	ax
		call	SYSUTILS_$$_FILEOPEN$UNICODESTRING$SMALLINT$$WORD
		mov	word [bp-6],ax
		mov	ax,word [bp-6]
...
EXTERN	SYSUTILS_$$_FILEOPEN$UNICODESTRING$SMALLINT$$WORD
