...
SECTION text
	ALIGN 2
	GLOBAL SYSUTILS_$$_FLOATTOSTRF$CURRENCY$TFLOATFORMAT$SMALLINT$SMALLINT$$ANSISTRING
SYSUTILS_$$_FLOATTOSTRF$CURRENCY$TFLOATFORMAT$SMALLINT$SMALLINT$$ANSISTRING:
		push	bp
		mov	bp,sp
		mov	ax,word [bp+20]
		push	ax
