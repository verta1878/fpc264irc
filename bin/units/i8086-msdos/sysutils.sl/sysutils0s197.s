...
SECTION text
	ALIGN 2
	GLOBAL SYSUTILS_$$_FLOATTOSTRF$EXTENDED$TFLOATFORMAT$SMALLINT$SMALLINT$$ANSISTRING
SYSUTILS_$$_FLOATTOSTRF$EXTENDED$TFLOATFORMAT$SMALLINT$SMALLINT$$ANSISTRING:
		push	bp
		mov	bp,sp
		mov	ax,word [bp+22]
		push	ax
