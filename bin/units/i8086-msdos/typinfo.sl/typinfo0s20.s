...
SECTION text
	ALIGN 2
	GLOBAL TYPINFO_$$_FINDPROPINFO$TOBJECT$ANSISTRING$TTYPEKINDS$$PPROPINFO
TYPINFO_$$_FINDPROPINFO$TOBJECT$ANSISTRING$TTYPEKINDS$$PPROPINFO:
		push	bp
		mov	bp,sp
		sub	sp,12
		mov	bx,word [bp+4]
		...
		lea	ax,[bp-6]
		push	ax
		call	TYPINFO_$$_GETPROPINFO$TOBJECT$ANSISTRING$TTYPEKINDS$$PPROPINFO
		mov	word [bp-2],ax
		cmp	word [bp-2],0
		je	..@j480
		jmp	..@j481
...
EXTERN	TYPINFO_$$_GETPROPINFO$TOBJECT$ANSISTRING$TTYPEKINDS$$PPROPINFO
