...
SECTION text
	ALIGN 2
	GLOBAL VARUTILS_$$_SAFEARRAYPTROFINDEX$PVARARRAY$PVARARRAYCOORARRAY$POINTER$$HRESULT
VARUTILS_$$_SAFEARRAYPTROFINDEX$PVARARRAY$PVARARRAYCOORARRAY$POINTER$$HRESULT:
		push	bp
		mov	bp,sp
		sub	sp,4
		push	word [bp+4]
