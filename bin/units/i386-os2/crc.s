...
.text
	.balign 4,0x90
.globl	CRC_GET_CRC32_TABLE$$PCARDINAL
CRC_GET_CRC32_TABLE$$PCARDINAL:
.globl	get_crc32_table
get_crc32_table:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$4,%esp
	movl	$TC_CRC_CRC32_TABLE,%eax
	movl	%eax,-4(%ebp)
	movl	-4(%ebp),%eax
	leave
	ret
...
.text
	.balign 4,0x90
.globl	CRC_CRC32$LONGWORD$PBYTE$LONGWORD$$LONGWORD
CRC_CRC32$LONGWORD$PBYTE$LONGWORD$$LONGWORD:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$16,%esp
	movl	%eax,-4(%ebp)
...
Lj15:
	...
	movl	-4(%ebp),%edx
	shrl	$8,%edx
	movl	TC_CRC_CRC32_TABLE(,%eax,4),%eax
	xorl	%edx,%eax
	movl	%eax,-4(%ebp)
	incl	-8(%ebp)
	movl	-8(%ebp),%eax
...
.text
	.balign 4,0x90
.globl	CRC_GET_CRC64_TABLE$$PQWORD
CRC_GET_CRC64_TABLE$$PQWORD:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$4,%esp
	movl	$TC_CRC_CRC64_TABLE,%eax
	movl	%eax,-4(%ebp)
	movl	-4(%ebp),%eax
	leave
	ret
...
.text
	.balign 4,0x90
.globl	CRC_CRC64$QWORD$PBYTE$LONGWORD$$QWORD
CRC_CRC64$QWORD$PBYTE$LONGWORD$$QWORD:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$16,%esp
	movl	%eax,-4(%ebp)
...
Lj51:
	...
	shrdl	$8,%edx,%ecx
	shrl	$8,%edx
	xorl	TC_CRC_CRC64_TABLE(,%eax,8),%ecx
	xorl	TC_CRC_CRC64_TABLE+4(,%eax,8),%edx
	movl	%ecx,8(%ebp)
	movl	%edx,12(%ebp)
	incl	-4(%ebp)
	movl	-4(%ebp),%eax
	...
	shrdl	$8,%ecx,%edx
	shrl	$8,%ecx
	xorl	TC_CRC_CRC64_TABLE(,%eax,8),%edx
	xorl	TC_CRC_CRC64_TABLE+4(,%eax,8),%ecx
	movl	%edx,8(%ebp)
	movl	%ecx,12(%ebp)
	incl	-4(%ebp)
	movl	-4(%ebp),%eax
...
.text
	.balign 4,0x90
.globl	CRC_assign$QWORD$$U128
CRC_assign$QWORD$$U128:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$4,%esp
	movl	%eax,-4(%ebp)
...
.text
	.balign 4,0x90
.globl	CRC_equal$U128$U128$$BOOLEAN
CRC_equal$U128$U128$$BOOLEAN:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$52,%esp
	movl	%esi,-52(%ebp)
...
.text
	.balign 4,0x90
.globl	CRC_xor$U128$U128$$U128
CRC_xor$U128$U128$$U128:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$16,%esp
	movl	%ebx,-16(%ebp)
...
.text
	.balign 4,0x90
.globl	CRC_xor$U128$BYTE$$U128
CRC_xor$U128$BYTE$$U128:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$12,%esp
	movl	%eax,-4(%ebp)
...
.text
	.balign 4,0x90
.globl	CRC_shr$U128$BYTE$$U128
CRC_shr$U128$BYTE$$U128:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$20,%esp
	movl	%ebx,-20(%ebp)
...
.text
	.balign 4,0x90
.globl	CRC_shl$U128$BYTE$$U128
CRC_shl$U128$BYTE$$U128:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$20,%esp
	movl	%ebx,-20(%ebp)
...
.text
	.balign 4,0x90
.globl	CRC_and$U128$U128$$U128
CRC_and$U128$U128$$U128:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$16,%esp
	movl	%ebx,-16(%ebp)
...
.text
	.balign 4,0x90
.globl	CRC_and$U128$QWORD$$QWORD
CRC_and$U128$QWORD$$QWORD:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$12,%esp
	movl	%eax,-4(%ebp)
...
.text
	.balign 4,0x90
.globl	CRC_GET_CRC128_TABLE$$PU128
CRC_GET_CRC128_TABLE$$PU128:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$4,%esp
	movl	$TC_CRC_CRC128_TABLE,%eax
	movl	%eax,-4(%ebp)
	movl	-4(%ebp),%eax
	leave
	ret
...
.text
	.balign 4,0x90
.globl	CRC_CRC128$U128$PBYTE$LONGWORD$$U128
CRC_CRC128$U128$PBYTE$LONGWORD$$U128:
	pushl	%ebp
	movl	%esp,%ebp
	subl	$332,%esp
	movl	%ebx,-332(%ebp)
...
Lj151:
	...
	shll	$4,%eax
	leal	-76(%ebp),%edi
	leal	TC_CRC_CRC128_TABLE(,%eax),%esi
	cld
	movl	$4,%ecx
	rep
	movsl
