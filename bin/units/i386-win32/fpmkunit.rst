...
# hash value = 166704258
fpmkunit.serrbuildoptnotexist='There are no build options with the name "'+
'%s"'
...
# hash value = 212115523
fpmkunit.sdbgmustcompile='Must compile %s'
