...
'ler .rc format'#13#10#13#10'.po format only options are:'#13#10'  -c cha'+
'r set    Adds a header specifying the given character set (OPTIONAL).'#13+
#10#13#10'OS/2 MSG file only options are:'#13#10'  -c identifier  Specifi'+
'es the component identifier (REQUIRED).'#13#10'                 Identifi'+
'er is any three chars in upper case.'#13#10'  -n number      Specifies t'+
'he first message number [1-9999] (OPTIONAL).'#13#10#13#10'Resource compi'+
'ler script only options are:'#13#10'  -s             Use STRINGTABLE ins'+
'tead of MESSAGETABLE'#13#10'  -c identifier  Use identifier as ID base ('+
'ID+n) (OPTIONAL)'#13#10'  -n number      Specifies the first ID number ('+
'OPTIONAL)'#13#10
