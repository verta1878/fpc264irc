// ============================================================================
//  sockets.pp  -  FPC RTL Sockets unit for DOS (i8086-msdos)
//
//  Drop-in replacement for the FPC Sockets unit, targeting DOS via the
//  Watt-32 TCP/IP library (libwatt.a).  Install into the FPC 2.6.x RTL
//  msdos directory so that `Uses Sockets` works transparently on 16-bit DOS
//  just like Linux, Windows, and OS/2.
//
//  i8086 port: uses wattcpwl.lib (16-bit large model, OpenWatcom).
//  This is the RTL-level fix: application code (Mystic, OpenOLMS, etc.)
//  should NOT need {$IFDEF GO32V2} around socket imports.
//
// ============================================================================
{$MODE DELPHI}
{$PACKRECORDS 1}
