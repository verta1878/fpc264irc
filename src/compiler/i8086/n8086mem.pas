    ...
    procedure ti8086addrnode.set_absvarsym_resultdef;
      begin
        if not(nf_typedaddr in flags) then
          ...
          resultdef:=tx86pointerdef.createx86(left.resultdef,x86pt_far);
      end;
...
*****************************************************************************}
   ...
   {$ifdef x86}
               (tcpupointerdef(left.resultdef).x86pointertyp = tx86pointerdef.default_x86_data_pointer_type) and
   {$endif x86}
             ...
             begin
               ...
               paraloc1.init;
               paramanager.getintparaloc(pd.proccalloption,1,paraloc1);
