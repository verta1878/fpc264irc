          ...
          begin
            ...
            if right.location.loc in [LOC_REFERENCE,LOC_CREFERENCE] then
              ...
              begin
                ...
                cg.a_load_loc_reg(current_asmdata.CurrAsmList,def_cgsize(u16inttype),right.location,hreg1);
        ...
        { shifting by 1 directly coded: }
          ...
          begin
            ...
            if right.nodetype=ordconstn then
              begin
                v:=Tordconstnode(right).value and 63;
                cg.a_load_const_reg(current_asmdata.CurrAsmList,def_cgsize(u16inttype),v,NR_CX);
              end
            else
              begin
                cg.a_load_loc_reg(current_asmdata.CurrAsmList,def_cgsize(u16inttype),right.location,NR_CX);
