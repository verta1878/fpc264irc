...
{$ENDIF}
    ...
    const
       { Codepage constants for the compiler — must match RTL values }
       CP_ACP   = 0;
       CP_UTF8  = 65001;
       CP_NONE  = 65535;
...
{$endif mswindows}
       ...
       begin
         ...
         Replace(s,'$FPCRELEASE',release_string);
         Replace(s,'$FPCRELEASEDATE',release_date);
         Replace(s,'$FPCRELEASETAG',release_tag);
