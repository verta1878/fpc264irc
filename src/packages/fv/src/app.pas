...
BEGIN
   ...
   ForEach(Pointer(@DoCountTileable));                         { Count tileable views }
   If (NumTileable>0) Then Begin
     ...
     Else Begin
       ...
       ForEach(Pointer(@DoTile));                              { Tile each view }
       DrawView;                                      { Now redraw }
     End;
   End;
END;
...
BEGIN
   ...
   ForEach(Pointer(@DoCount));                                 { Count cascadable }
   If (CascadeNum>0) Then Begin
     ...
     TileError Else Begin                             { Check for error }
       ...
       ForEach(Pointer(@DoCascade));                           { Cascade view }
       DrawView;                                      { Redraw now }
     End;
   End;
END;
