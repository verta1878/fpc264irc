...
## Notes
- "rFf=" in RIPAINT.EXE is a code reference, not a file magic number
- Format never publicly documented by TeleGrafix
- Reverse-engineered from binary analysis of RFF files + RIPAINT.EXE strings
