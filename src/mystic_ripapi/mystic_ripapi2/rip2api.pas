...
Type
  ...
  Public
    ...
    Function  LoadJPG       (FileName: String; X, Y: SmallInt) : Boolean;  // JPEG pixel rendering via jpegdecraw
...
Uses
  JPEGDecRaw;  // v2.0: standalone {$H-} JPEG decoder
...
// JPEG loader — decodes and renders pixels using jpegdecraw.pas ({$H-} compatible)
Var
  Pixels : PByte;
  W, H   : Integer;
  IX, IY : Integer;
