...
Uses
  JPEGDecRaw, GIFDecRaw, PNGDecRaw, RFFDecRaw,  // v3.0 Phase 17-18: image decoders
  BMPDec, PCXDec, TGADec, PBMDec, ICODec,        // v3.0 image format decoders
  PNGCodec, PNGInterlace,                         // v3.0 PNG encoder/decoder + interlaced
  GIFAnim, GIFInterlace,                          // v3.0 animated + interlaced GIF
  JPEGProg, SpriteAnim,                           // v3.0 progressive JPEG + sprite animation
  GRFill, GRFx, GRBezier, GRTexMap, GRClip,      // v3.0 Phase 23: advanced graphics
  RIPDecRaw, RIPBinDec, RIPTile,                  // v3.0 progressive rendering
  RIPLayerDec, RIPChange, RIPRender,              // v3.0 progressive rendering
  MIDISynth;                                      // v3.0 Phase 22: FM synthesis
...
// Pixel decoding via jpegdecraw.pas (Phase 17) or pasjpeg (v2 compat)
