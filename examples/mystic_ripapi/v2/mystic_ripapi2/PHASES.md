...
- [ ] JPEG streaming (JPEGStreamInit/Feed/Complete — from v3 Phase 17)
- [ ] PNG support (pngdecraw.pas — from v3 Phase 17)
- [ ] FLAC decoder (flacdec.pas — from v3 codecs)
- [ ] MP3 decoder (mp3dec.pas — from v3 codecs)
- [x] WAV streaming implementation (WAVStreamInit/Feed/Stop/IsPlaying — state tracking)
- [ ] Audio codec wiring (pcmdecraw/pcmmix/wavplay integration)
