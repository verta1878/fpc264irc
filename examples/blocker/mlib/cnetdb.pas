{ cnetdb.pas — Compatibility shim for Mystic BBS m_io_sockets.
  Maps old cNetDB types to FPC's netdb unit.
  FPC 2.6.4irc — cNetDB retired, netdb is replacement. }
{$MODE OBJFPC}{$H+}
unit cnetdb;
interface
uses Sockets, netdb;
...
procedure freehostent(P: PHostEnt); begin end;
end.
