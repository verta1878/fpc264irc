...
function  FossilInit(Port: Byte): Word;
procedure FossilDeinit(Port: Byte);
function  FossilReadBlock(Port: Byte; var Buf; Count: Word): Word;
function  FossilWriteBlock(Port: Byte; const Buf; Count: Word): Word;
function  FossilStatus(Port: Byte): Word;
...
begin
  ...
  R.AH := $04; R.DX := Port;
  FossilDispatch(R);
  Result := (Word(R.AH) shl 8) or R.AL;
end;
...
function FossilReadBlock(Port: Byte; var Buf; Count: Word): Word;
var R: TFossilRegs; I: Word; B: Byte;
begin
  Result := 0;
